...
export const WEAPON_IMAGES: Array<{ type: (typeof WEAPON_TYPES)[number]; imgSrc: string }> = [
...
export const ARTIFACT_IMAGES: Array<{ type: (typeof ARTIFACT_TYPES)[number]; imgSrc: string }> = [
