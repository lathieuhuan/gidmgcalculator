import type { AmplifyingReaction, AppArtifact, ArtifactModifier, ElementType, QuickenReaction } from "@Src/types";
import { Green } from "@Src/pure-components";
import { parseArtifactDescription, round, toArray } from "@Src/utils";
