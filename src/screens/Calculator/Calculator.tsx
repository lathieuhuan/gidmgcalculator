  ...
  return (
    <div className={clsx("pb-1 flex items-center overflow-auto", styles.calculator)}>
      <div className="h-98/100 flex space-x-2">
        ...
        {/* Panel 2 */}
        <div className={clsx("px-6 py-4 bg-darkblue-1", styles.card)}>{touched && <Modifiers />}</div>
        ...
        {/* Panel 4 */}
        <div className={clsx("px-4 pt-2 pb-6 bg-darkblue-3 relative", styles.card)}>{touched && <DamageResults />}</div>
      </div>
    </div>
  );
};
