...
const Lisa: DataCharacter = {
  ...
  activeTalents: {
    NA: {
      stats: [
        { name: "1-Hit", baseMult: 39.6 },
        { name: "2-Hit", baseMult: 35.92 },
        { name: "3-Hit", baseMult: 42.8 },
        { name: "4-Hit", baseMult: 54.96 },
      ],
    },
    CA: { stats: [{ name: "Charged Attack", baseMult: 177.12 }] },
    PA: { stats: LIGHT_PAs },
    ES: {
      name: "Violet Arc",
      ...
      xtraLvAtCons: 5,
      stats: [
        { name: "Press DMG", baseMult: 80 },
        { name: "0-stack Hold", baseMult: 320 },
        { name: "1-stack Hold", baseMult: 368 },
        { name: "2-stack Hold", baseMult: 424 },
        { name: "3-stack Hold", baseMult: 487.2 },
      ],
      // getExtraStats: () => [
    ...
    EB: {
      ...
      xtraLvAtCons: 3,
      stats: [{ name: "Discharge DMG", baseMult: 36.56 }],
      // getExtraStats: () => [
