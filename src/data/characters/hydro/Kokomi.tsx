...
const Kokomi: DataCharacter = {
  ...
  activeTalents: {
    NA: {
      stats: [
        { name: "1-Hit", baseMult: 68.38 },
        { name: "2-Hit", baseMult: 61.54 },
        { name: "3-Hit", baseMult: 94.31 },
      ],
    },
    CA: { stats: [{ name: "Charged Attack", baseMult: 148.32 }] },
    PA: { stats: LIGHT_PAs },
    ES: {
      name: "Kurage's Oath",
      ...
      stats: [
        ...
        { name: "Ripple DMG", baseMult: 109.19 },
      ],
      // getExtraStats: () => [
    ...
    EB: {
      ...
      xtraLvAtCons: 3,
      stats: [
        { name: "Skill DMG", baseStatType: "hp", baseMult: 10.42 },
        {
