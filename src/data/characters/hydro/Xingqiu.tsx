...
const Xingqiu: DataCharacter = {
  ...
  activeTalents: {
    NA: {
      stats: [
        { name: "1-Hit", multFactors: { root: 46.61 } },
        { name: "2-Hit", multFactors: { root: 47.64 } },
        { name: "3-Hit (1/2)", multFactors: { root: 28.55 } },
        { name: "4-Hit", multFactors: { root: 55.99 } },
        { name: "5-Hit (1/2)", multFactors: { root: 35.86 } },
      ],
    },
    CA: {
      stats: [{ name: "Charged Attack", multFactors: [{ root: 47.3 }, { root: 56.16 }] }],
    },
    PA: { stats: MEDIUM_PAs },
    ES: {
      ...
      xtraLvAtCons: 5,
      stats: [{ name: "Skill DMG", multFactors: [{ root: 168 }, { root: 191.2 }] }],
      // getExtraStats: (lv) => [
    ...
    EB: {
      ...
      xtraLvAtCons: 3,
      stats: [{ name: "Sword Rain", multFactors: { root: 54.27 } }],
      // getExtraStats: () => [
      //   { name: "Duration", value: "15s" },
      //   { name: "CD", value: "20s" },
      // ],
