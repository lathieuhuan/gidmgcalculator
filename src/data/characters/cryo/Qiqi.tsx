  ...
  activeTalents: {
    NA: {
      stats: [
        ...
        { name: "2-Hit", baseMult: 38.87 },
        { name: "3-Hit (1/2)", baseMult: 24.17 },
        { name: "4-Hit (1/2)", baseMult: 24.68 },
        { name: "5-Hit", baseMult: 63.04 },
      ],
    },
    CA: { stats: [{ name: "Charged Attack (1/2)", baseMult: 64.33 }] },
    PA: { stats: MEDIUM_PAs },
    ES: {
      ...
      xtraLvAtCons: 5,
      stats: [
        { name: "Skill DMG", baseMult: 96 },
        { name: "Herald DMG", baseMult: 36 },
        {
          name: "Regen. on Hit",
          notAttack: "healing",
          baseStatType: "atk",
