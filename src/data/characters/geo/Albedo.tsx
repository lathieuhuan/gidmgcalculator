...
const Albedo: DefaultAppCharacter = {
  ...
  buffs: [
    ...
    },
    {
      ...
      src: EModSrc.C2,
      affect: EModAffect.SELF,
      description: `Transient Blossoms grant Albedo Fatal Reckoning for 30s. Unleashing Rite of Progeniture: Tectonic
      Tide [EB] consumes all stacks, each increases Albedo's {[EB] DMG}#[gr] by {30%}#[b,gr] of his {DEF}#[gr}. This
      effect stacks up to {4}#[r] times.`,
    ...
    },
    {
      ...
      src: EModSrc.C6,
      affect: EModAffect.ACTIVE_UNIT,
      description: `Active party members within the Solar Isotoma [ES] field who are protected by a shield created by Crystallize
      have their {DMG}#[gr] increased by {17%}#[b,gr].`,
