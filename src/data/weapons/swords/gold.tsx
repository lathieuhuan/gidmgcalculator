...
const goldSwords: AppWeapon[] = [
  {
    ...
    description: {
      pots: [
        ...
        `When Normal Attacks deal Elemental DMG, the Foliar Incision effect will be obtained, increasing Normal Attack
        and Elemental Skill DMG by {1}% of Elemental Mastery.`,
  ...
  },
  {
    ...
    description: {
      pots: [
        ...
        equipping character's Elemental Mastery by {1}% of their Max HP. This effect can trigger once every 0.3s. Max 3
        stacks.`,
        `When Grand Hymn effect gains 3 stacks, or when the third stack's duration is refreshed, the Elemental Mastery
        of all nearby party members will be increased by {2}% of the equipping character's Max HP for 20s.`,
      ],
      seeds: [15, 0.09, 0.15],
    },
    autoBuffs: [
  ...
  },
  {
    ...
    description: {
      pots: [
        ...
        equipping this weapon will gain 1 Wavespike stack. Max 2 stacks. This effect can be triggered once every 0.3s.
        ...
        `Each stack of Wavepike consumed will increase Normal Attack DMG by {1}% for 8s.`,
      ],
      seeds: [9, 15],
    },
    autoBuffs: [
